...
def main(model_args, data_args, training_args):
    ...
    # datasets - 데이터 셋 만드는 것
    df = pd.read_csv(os.path.join(BASE_DIR, 'data/train_data.csv'))
    ...
    trainer = SFTTrainer(
        ...
        peft_config=peft_config, # LoRA 사용하기 위한 config
    ...
    # train - 체크포인트 다음에 학습 할 수 있게 하는 코드
    checkpoint = None
